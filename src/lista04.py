...
root_finding.linear_iteration(g, -2, 4)
...
root_finding.mixed(f, f_prime, 3, 9, 9)
...
root_finding.secant(f, 3, 4, 0.01, 10)
...
root_finding.linear_iteration(g, 0, 4)
...
root_finding.newton_raphson(f, f_prime, 1)
...
root_finding.mixed(f, f_prime, -4, -1, -4)
...
root_finding.newton_raphson(f, f_prime, 3)
